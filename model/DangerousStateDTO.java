...
public class DangerousStateDTO {
    ...
    private List<NetworkHazardPhoto> networkHazardPhotos;
    ...
    public List<NetworkHazardPhoto> getNetworkHazardPhotos() {
        return networkHazardPhotos;
    }

    public void setNetworkHazardPhotos(List<NetworkHazardPhoto> networkHazardPhotos) {
        this.networkHazardPhotos = networkHazardPhotos;
    }
