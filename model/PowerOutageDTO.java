...
public class PowerOutageDTO {
	...
	private List<Long> exyphretoumeniPerioxiIdList;
	...
	public List<Long> getExyphretoumeniPerioxiIdList() {
		return exyphretoumeniPerioxiIdList;
	}

	public void setExyphretoumeniPerioxiIdList(List<Long> exyphretoumeniPerioxiIdList) {
		this.exyphretoumeniPerioxiIdList = exyphretoumeniPerioxiIdList;
	}
